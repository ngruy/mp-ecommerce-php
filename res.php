...
<html class="supports-animation supports-columns svg no-touch no-ie no-oldie no-ios supports-backdrop-filter as-mouseuser" lang="en-US"><head>
        ...
        <style type="text/css"> @keyframes loading-rotate {
            ...
            .mp-spinner-path {
                ...
                stroke-width: 2px;
                stroke: #009ee3;
            } </style><style type="text/css"> .mercadopago-button {
                ...
                cursor: pointer;
                border: 0;
                } </style><style type="text/css"> @keyframes loading-rotate {
                100% {
                    transform: rotate(360deg);
                }
            }
                                ...
                                <div class="column small-12 as-search-results-tiles as-search-results-width">
                                    <center>
                                        ...
                                        if (isset($_GET['res'])) {
                                            switch ($_GET['res']) {
                                                case RES_SUCCESS:
                                                    echo '<h2><p class="' . RES_SUCCESS . '"> Tu pago se realizó correctamente.<br>Gracias por tu compra!</p></h2><br>';
                                                    break;
                                                case RES_PENDING:
                                                    echo '<h2><p class="' . RES_PENDING . '"> Te notificaremos cuando se efectúe el pago.<br>Gracias por tu compra!</p></h2><br>';
                                                    break;
                                                case RES_FAILURE:
                                                    echo '<h2><p class="' . RES_FAILURE . '"> Algo salió mal.<br>Por favor, vuelve a intentarlo!</p></h2><br>';
                                                    break;
                                                default:break;
                                            }
                                            unset($_GET['res']);
                                        ...
                                        ?>
                                        <h3>Información de Respuesta del Pago</h3>
                                        <table>
                                            <tr>
                                                <th><b>Atributo</b></th>
                                                <th>&emsp;&emsp;<b>Valor</b></th>
                                            </tr>

                                            <?php
                                            foreach ($_GET as $key => $val) {
                                                if ($val != 'null') {
                                                    echo '<tr>' . '<td>' . $key . '</td><td>&emsp;&emsp;' . $val . '</td>' . '</tr>';
                                                }
                                            }
                                            ?>
                                            <tr>
